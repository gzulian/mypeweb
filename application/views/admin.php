              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 <?php foreach ($admin as $tm): ?>
                    ...
                    <td align="center"><a href="#<?=$tm->get('adm_user')?>"><img src="<?=base_url('')?>resources/images/<?=$tm->get('adm_photo')?>" style="width:40px; height:40px;  border-radius: 50%;"></a></td>
                    ...
                    <a href="#_" class="lightbox" id="<?=$tm->get('adm_user')?>">
                      <img src="<?=base_url('')?>resources/images/<?=$tm->get('adm_photo')?>">
                    </a>
                   <?php endforeach ?>
                </tfoot>
              </table>
