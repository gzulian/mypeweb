        ...
        <div class="panel-group" 
             ...
             <?php foreach ($customer as $cu): ?>
                    <div class="panel panel-primary" 
                      ...
                      <button type="button"  fakeid="<?=$cu->getCol('cus_email')?>" faketema="<?=$cu->getCol('new_subject')?>" fakenombre="<?=$cu->getCol('cus_name')?>" fakemsj="<?=$cu->getCol('new_text')?>" fakenewlog="<?=$cu->getCol('log_id')?>" class="btn btn-primary getMail"  data-toggle="modal" data-target="#new_modal" data-dismiss="modal">Responder <i class="fa fa-mail-forward"></i>  </button>
                      </div>
                      <div>
